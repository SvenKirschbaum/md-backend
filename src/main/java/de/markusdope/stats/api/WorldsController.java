    ...
    private final Mono<String> schedule =
            Mono.defer(
                    () ->
                            webClient
                                    .get()
                                    .uri("https://lol.gamepedia.com/api.php?action=cargoquery&format=json&smaxage=0&tables=MatchSchedule&fields=DateTime_UTC,Team1,Team2&where=OverviewPage LIKE \"2024 Season World Championship/%\"&limit=max")
                                    .retrieve()
